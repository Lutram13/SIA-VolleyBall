        ...
        <form method="POST" action="{{ route('login') }}">
            <h1 class="h3 mb-3 fw-normal">Silahkan Login</h1>
                ...
                <div class="form-floating">
                    <input type="name" class="form-control" id="floatingInput" placeholder="Username" @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
